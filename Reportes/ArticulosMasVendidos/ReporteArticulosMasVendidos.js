$(document).ready(function () {
    ...
    $.ajax({
        url: "https://localhost:5001/Articulos/ReporteProductosMasVendidos",
        type: "GET",
        dataType: "json",
...
$("#btnFiltrarFecha").click(function () {
  ...
  function filtrarFecha(fechaInicial, fechaFinal) {
    ...
    var cantidades = [];
    $.ajax({
        url: "https://localhost:5001/Clientes/reporteArticulos?lim_inf=" + fechaInicial + "&lim_sup=" + fechaFinal,
        type: "GET",
        dataType: "json",
        contentType:"application/json",
        success: function (result) {
